                                ...
                                <form method="PUT" action="/catalog">
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <input type="text" class="form-control" value="{{$arkib->nama}}" name="nama">
                                        </td>
                                        <td class="text-center">
                                            <input type="text" class="form-control" value="{{$arkib->pemilik}}" name="pemilik">
                                        </td>
                                        <td class="text-center">
                                            <input type="text" class="form-control" value="{{$arkib->tag}}" name="tag">
                                        </td>
                                        <td class="text-center">
                                            <input type="text" class="form-control" value="{{$arkib->jenis}}" name="jenis">
                                        </td>
                                        <td class="text-center">
